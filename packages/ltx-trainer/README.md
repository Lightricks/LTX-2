...
- **CUDA or Apple Silicon MPS** - CUDA 13+ is recommended for optimal training throughput; Apple Silicon Macs can use
  the `mps` backend for local preprocessing, validation, and smaller single-process runs
